...
var RabbitInMemory_1 = __importDefault(require("./RabbitInMemory"));
/**
 ...
 */
var publish = function (options) { return __awaiter(void 0, void 0, void 0, function () {
    var rabbitInstance;
    return __generator(this, function (_a) {
        rabbitInstance = RabbitInMemory_1.default.getInstance();
        return [2 /*return*/, rabbitInstance.publishRoute(options)];
    });
}); };
/**
...
var subscribe = function (options) {
    var rabbitInstance = RabbitInMemory_1.default.getInstance();
