...
var RabbitOnMemory = /** @class */ (function () {
     ...
     */
    RabbitOnMemory.prototype.deleteExpired = function () {
        var _this = this;
        this.routes.forEach(function (queues, route) {
            var filtered = queues.filter(function (queue) {
            ...
            if (filtered.length === 0) {
                _this.routes.delete(route);
            }
            else {
                _this.routes.set(route, filtered);
            }
        });
    };
    ...
    RabbitOnMemory.prototype.bindQueue = function (exchange, exchangeType, queue, bindRoute, callback, options) {
        // Define exchange
        ...
        var queues = this.routes.get(bindRoute) || [];
    ...
    RabbitOnMemory.prototype.publishRoute = function (exchange, routingKey, content, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        exchangeType = this.exchanges.get(exchange);
                        if (!exchangeType) {
                            error = new Error();
                        ...
                        if (!(exchangeType === 'fanout')) return [3 /*break*/, 2];
                        if (this.configuration.debug) {
                            console.log("Publishing in fanout mode");
                        }
                        return [4 /*yield*/, this.processQueuesFanout(message)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 2:
                        if (!(exchangeType === 'direct')) return [3 /*break*/, 4];
                        if (this.configuration.debug) {
                            console.log("Publishing in direct mode");
                        }
                        return [4 /*yield*/, this.processQueuesDirect(routingKey, message)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 4:
                        if (!(exchangeType === 'topic')) return [3 /*break*/, 6];
                        if (this.configuration.debug) {
                            console.log("Publishing in topic mode");
                        }
                        return [4 /*yield*/, this.processQueuesTopic(routingKey, message)];
                    case 5:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 6:
